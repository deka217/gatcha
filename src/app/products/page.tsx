export default function FirstPProductsost() {
  return (
    <section className="relative bg-yosh-blue">
      ...
      <h3 className="text-6xl font-gluten font-bold text-yosh-yellow text-center py-8">
      Products
            </h3>
          <div className="text-center  pb-12 md:pb-16 mx-auto flex space-x-6">
            
            <div className=" bg-white border-b-8 border-yellow-700 max-w-md mx-auto rounded-lg overflow-hidden shadow-md hover:shadow-lg">
              <div className="">
                <img
                  className="w-[500px]"
                  src="kartu-yosh.png"
              ...
              <div className="p-4 flex items-center justify-between">
                <div className="flex flex-col space-y-2">
                  <span className="font-bold text-2xl text-yosh-blue">Collectible Cards</span>
                  <p className="">
                    Create your own good quality collectible cards and promote
                    your IP on a whole new level!
                  </p>
                </div>

                <button className="bg-yosh-blue hover:bg-blue-600 text-white  py-2 px-4 rounded">
                Levels of collectibles: R, SR, SSR, SSSR
                </button>
              </div>
            </div>
